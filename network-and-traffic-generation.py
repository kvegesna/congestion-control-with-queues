...
def BwidthTest( lossy=True ):
    ...
    process  = h1.popen("iperf -c 10.0.0.4 -p 5001 -t 90 -i 1", shell=True)
    ...
    process  = h1.popen("iperf -u -c 10.0.0.2 -p 5001 -t 5 -b 2M", shell=True)
    stdout, stderr = process.communicate()
    print( stdout )
    print( "Throughput between h1 and h4, bwidth of 4" ) 
    process  = h1.popen("iperf -u -c 10.0.0.2 -p 5001 -t 5 -b 4M", shell=True)
    stdout, stderr = process.communicate()
    print( stdout )
    print( "Throughput between h1 and h4, bwidth of 6" ) 
    process  = h1.popen("iperf -u -c 10.0.0.2 -p 5001 -t 5 -b 6M", shell=True)
    stdout, stderr = process.communicate()
    print( stdout )
    print( "Throughput between h1 and h4, bwidth of 8" ) 
    process  = h1.popen("iperf -u -c 10.0.0.2 -p 5001 -t 5 -b 8M", shell=True)
    stdout, stderr = process.communicate()
    print( stdout )
    print( "Throughput between h1 and h4, bwidth of 10" ) 
    process  = h1.popen("iperf -u -c 10.0.0.2 -p 5001 -t 5 -b 10M", shell=True)
    stdout, stderr = process.communicate()
    print( stdout )
    net.stop()
